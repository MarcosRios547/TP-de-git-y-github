...
def informacion_personal(nombre, apellido, edad, residencia):
    return f"Hola {nombre}; {apellido}; {edad}; {residencia}"

nombre = input("ingrese su nombre: ")
apellido = input("ingrese su apellido: ")
edad = input("ingrese su edad ")
residencia = input("ingrese si residencia: ")
...
# y devuelva una tupla con el resultado de sumarlos, restarlos, multiplicarlos y dividirlos. Mostrar los resultados 
# de forma clara.
